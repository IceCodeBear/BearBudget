...
const RA401k = () => (
  <Container text>
    ...
    <p>A 401k is a compamy sponsored retirement plan that allows employees to contribute a portion of their pre-tax paycheck to the retirement account.</p>
    ...
    <p>If you withdraw the money early, you are subject to a 10% penalty on top of tax.</p>
